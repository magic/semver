...
export default [
  ...
  { fn: bump('0.1.1-alpha.0', { major: true }), expect: '1.0.0', info: '0.1.1-alpha.0 can be bumped to 1.0.0' },
  { fn: bump('0.1.1-alpha.0', { minor: true }), expect: '0.2.0', info: '0.1.1-alpha.0 can be bumped to 0.2.0' },
  { fn: bump('0.1.1-alpha.0', { patch: true }), expect: '0.1.2', info: '0.1.1-alpha.0 can be bumped to 0.1.2' },

  { fn: bump('0.1.1-alpha.0', { alpha: true }), expect: '0.1.1-alpha.1', info: '0.1.1-alpha.0 can be bumped to 0.1.1-alpha.1' },

  { fn: bump('0.1.1-alpha.0'), expect: '0.1.1-alpha.1', info: '0.1.1-alpha.0 without args bumps to 0.1.1-alpha.1' },
  { fn: bump('0.1.1'), expect: '0.1.2', info: '0.1.1 without args bumps to 0.1.2' },

  { fn: bump('0.1.1', { alpha: true }), expect: '0.1.1-alpha.0', info: '0.1.1 without { alpha: true } bumps to 0.1.1-alpha.0' },
